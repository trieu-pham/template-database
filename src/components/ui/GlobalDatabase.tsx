      ...
      >
        ...
        <div className="z-20 -mt-32 h-144 w-full overflow-hidden md:-mt-36">
          ...
          <div className="absolute inset-x-6 bottom-12 m-auto max-w-4xl md:top-2/3">
            <div className="grid grid-cols-1 gap-x-10 gap-y-6 rounded-lg border border-white/3 bg-white/1 px-6 py-6 shadow-xl backdrop-blur-sm md:grid-cols-3 md:p-8">
              {features.map((item) => (
